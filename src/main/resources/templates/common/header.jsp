      ...
      <li>
        <div class="btn-group">
          <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
 			<img src='<c:if test="${empty user.headImg}"><%=staticPath%>/images/photos/loggeduser.png</c:if>${user.headImg}' alt="" /> 
 			         ${user.userName }
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
      	<div class="photoContent">
		  	...
		  	<div class="cropped">
		  		<p>头像预览</p>
		  		<img id="headImg" src="<%=staticPath%>/images/photos/loggeduser.png" align="absmiddle" style="width:180px;margin-top:4px;border-radius:180px;box-shadow:0px 0px 12px #7E7E7E;">
		  		<p>180px*180px</p>
		  	</div>
	  	</div>
      </div>
